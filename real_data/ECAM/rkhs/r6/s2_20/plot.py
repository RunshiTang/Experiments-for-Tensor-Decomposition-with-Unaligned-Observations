...
import os
os.chdir("//sscwin/dfsroot/Users/rtang56/Desktop/RKHS_new_new/RKHS/real_data/r6/s2_20")
...
plt.xscale('log')
plt.xlim(-0.4, 10.1)
plt.ylim((1-0.79)**2, (1 - 0.35)**2)
plt.tight_layout()

plt.savefig('comparison_r6_s2_20_realdata.pdf', format = 'pdf')
