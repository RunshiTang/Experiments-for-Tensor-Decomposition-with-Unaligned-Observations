...
import os
os.chdir("//sscwin/dfsroot/Users/rtang56/Desktop/RKHS_new_new/Generalized_RKHS/real_data/beta_divergence/r_6/s2_40")
...
plt.savefig('beta_d_r_6_s2_40.pdf', format = 'pdf',bbox_inches='tight')
