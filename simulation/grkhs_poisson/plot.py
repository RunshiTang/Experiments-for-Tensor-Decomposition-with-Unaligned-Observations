...
import os
os.chdir("//sscwin/dfsroot/Users/rtang56/Desktop/RKHS_new_new/Generalized_RKHS/simulation/poisson2/setting1")
...
acc_list_list = acc_list_list + 20.78248
...
acc_unsketched = acc_unsketched + 20.78248
...
plt.axhline(y = -20.78248, linestyle = ':', color = "#17becf", linewidth = 0.5)
